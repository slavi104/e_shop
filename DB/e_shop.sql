...
ALTER TABLE `users` ADD `user_type` VARCHAR(255) NOT NULL DEFAULT 'person' ;

ALTER TABLE `users` ADD `address` TEXT NULL DEFAULT NULL , ADD `phone` VARCHAR(255) NULL DEFAULT NULL , ADD `contact_data` TEXT NULL DEFAULT NULL ;